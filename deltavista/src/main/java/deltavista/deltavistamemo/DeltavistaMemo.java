...
import deltavista.mylibrary.AutoFitText;

public class DeltavistaMemo extends Activity {
...
// Writing shops to log
    ...
    public void Komponenten_aufbauen() {
        ...
        QBild[0] = R.drawable.michael;
        QBild[1] = R.drawable.melani;
        QBild[2] = R.drawable.darek;
